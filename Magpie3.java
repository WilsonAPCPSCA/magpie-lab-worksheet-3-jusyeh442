	...
	public String getResponse(String statement) {
				...
				|| findKeyword(statement, "brother") >= 0)
		{
			...
			response = "Tell me more about your pets.";
				...
				|| findKeyword(statement, "Trimborn") >= 0
				|| findKeyword(statement, "Rogan") >= 0
				|| findKeyword(statement, "Arteaga") >= 0
				|| findKeyword(statement, "Robles") >= 0
				|| findKeyword(statement, "Young") >= 0)
		{
			if (findKeyword(statement, "Mr.") >= 0) {
				response = "He sounds like a swell teacher.";
			} else if (findKeyword(statement, "Mrs.") >= 0 || statement.indexOf("Ms.") >= 0) {
				response = "She sounds like a swell teacher.";
			} else {
				response = "Your teacher sounds like a swell teacher.";
			}
			...
			response = "Hmmm, now I'm craving Italian.";

		} else if (findKeyword(statement, "banana") >= 0) {
			response = "Monkey!";

		} else if (findKeyword(statement, "school") >= 0) {
			response = "Try to keep up the good grades!";
